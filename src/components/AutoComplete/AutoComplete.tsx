  ...
  //   查询后列表的函数生成 
   ...
   return ( 
    ...
    {suggestions.map((item, index) => {
       const classes=  classNames('instant-auto-complete-item',{ 'is-active': index === heightIndex }) 
      return (
     ...
     return ( 
        <>
            ...
            />
            {loading && <ul className='instant-auto-complete-list'><div className='suggstions-loading-icon'><Icon icon={'spinner'} spin></Icon> </div> </ul>}     
